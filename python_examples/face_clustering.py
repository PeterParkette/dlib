...
print(f"Number of clusters: {num_classes}")
...
print(f"Biggest cluster id number: {biggest_class}")
print(f"Number of faces in biggest cluster: {biggest_class_length}")

indices = [i for i, label in enumerate(labels) if label == biggest_class]
print(f"Indices of images in the biggest cluster: {indices}")
...
for i, index in enumerate(indices):
    ...
    file_path = os.path.join(output_folder_path, f"face_{str(i)}")
